...
Nettoyage  (wv clip ≥ 0 · dropna)
        ↓
Split chronologique strict  70 / 15 / 15
        ↓
...
> Si `best_cnn.keras` est absent du dossier `saved_model/`,
> l'API démarre automatiquement en **mode démonstration**
> avec un badge d'avertissement sur la page de prédiction.

---

## 9 Commandes Git utiles

Après chaque modification de vos fichiers, ces 3 commandes suffisent :
```bash
git add .
